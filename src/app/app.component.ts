      ...
      heatmap;
       ...
       initMap() {
        ...
        this.map.addListener("maptypeid_changed", () => {
          ...
          let mapStyleSelect: HTMLElement  = document.getElementById('style-selector-control');

          if ( this.map.mapTypeId === "satellite") {
            //remove type map  style-selector-control
            mapStyleSelect.setAttribute("style","display:none !important;position: absolute;");
            console.log("display nome satelite");
          

          }else{
            //add types map
            mapStyleSelect.setAttribute("style","display:block !important;position: absolute;");
            console.log("display block map");
